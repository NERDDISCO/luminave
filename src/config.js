export default {
  ...
  'scenes': [{
      ...
      'layers': [{
        'layerId': 'layer1',
        'devices': ['fungeneration_ledspot_1', 'fungeneration_ledspot_2', 'fungeneration_ledspot_3', 'fungeneration_ledspot_4', 'cameo_ledspot_1', 'cameo_ledspot_2', 'cameo_pixbar_1', 'adj_planet'],
        'animations': [{
          'start': 0,
          'animationId': 'allthelight'
        }]
