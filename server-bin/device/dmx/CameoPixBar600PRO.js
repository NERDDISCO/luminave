...
var CameoPixBar600PRO = function (_fivetwelve$DmxDevice) {
  ...
  function CameoPixBar600PRO(options) {
    ...
    var _this = _possibleConstructorReturn(this, (CameoPixBar600PRO.__proto__ || Object.getPrototypeOf(CameoPixBar600PRO)).call(this, Object.assign({}, options, {
      params: {
    ...
    _this.layout = {};
    _this.layout.width = 12;
    _this.layout.height = 1;
    return _this;
  }

  _createClass(CameoPixBar600PRO, [{
    key: 'reset',
    value: function reset() {
      console.log('asdf');
      var defaultColor = 'rgb(0, 255, 0)';
